    ...
    this.queue = new JobQueue(
      {
        comparator: function comparator(jobA, jobB) {
          const priorityA = (jobA.payload.hasOwnProperty('priority'))
            ? jobA.payload.priority : self.DEFAULTS.priority;
          const priorityB = (jobB.payload.hasOwnProperty('priority'))
            ? jobB.payload.priority : self.DEFAULTS.priority;
